...
class FiveBandResistence extends StatefulWidget {
  const FiveBandResistence({super.key});

  @override
  State<FiveBandResistence> createState() => _FiveBandResistenceState();
}

class _FiveBandResistenceState extends State<FiveBandResistence> {
