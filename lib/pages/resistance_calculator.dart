...
//const List<String> list = <String>['Negro', 'Marrón', 'Rojo', 'Naranja', 'Amarilla', 'Verde', 'Azul','Purpura', 'Gris', 'Blanco'];
enum Col{Negro, Marron, Rojo, Naranja, Amarilla, Verde, Azul,Purpura, Gris, Blanco}
enum ColP{Marron, Rojo, Dorado, Plateado}
enum ColM{Negro, Marron, Rojo, Naranja, Amarilla,Verde ,Azul ,Dorado, Plateado}
class ResistanceCalculator extends StatefulWidget {
  const ResistanceCalculator({super.key});

  @override
  State<ResistanceCalculator> createState() => _ResistanceCalculatorState();
}
                        ...
                        Expanded(
                          child: DropdownButton(
                            items: const[
                              ...
                              DropdownMenuItem(child: Text("Verde"), value: ColM.Verde,),
                              DropdownMenuItem(child: Text("Azul"), value: ColM.Azul,),
